                ...
                <div class="card-body p-3">
                    <form class="row g-3 align-items-center">
                        ...
                        <div class="col-md-2">
                         ...
                         <div class="col-md-3">
                            <div class="form-check form-switch">
                                <input class="form-check-input" type="checkbox" id="delivered_only" checked
                                    wire:model="delivered_only">
                                <label class="form-check-label"
                                    for="delivered_only">{{ $lang->data['delivered_sms_only'] ?? 'Delivered Status SMS only' }}</label>
                            </div>
                        </div>
                        <div class="mt-5"><span
