            ...
            <div class="card">
                <div class="card-body p-3">
                    <form class="row g-3 align-items-center">
                        ...
                        <div class="col-md-3">
                            <label class="form-label">{{ $lang->data['currency_alignment'] ?? 'Currency Alignment' }}</label>
                            <select class="form-select" wire:model="currency_alignment">
                        ...
                        <div class="col-md-3">
                            <label
                                class="form-label">{{ $lang->data['country_code'] ?? 'Country Code' }}</label>
                            <input type="text" class="form-control" placeholder="{{ $lang->data['country_code'] ?? 'Country Code' }} (+91)" wire:model="country_code">
                            @error('country_code')
