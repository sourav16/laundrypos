<div>
    <div class="row align-items-center justify-content-between mb-4">
        ...
        <div class="col-auto">
            <a wire:click="downloadFile()" class="btn btn-icon btn-3 btn-white text-secondary mb-0">
                        ...
                        <table class="table align-items-center mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <p class="text-sm px-3 mb-0">{{getCountryCode()}} {{ $row->phone }}</p>
                                    ...
                                    <td>
                                        <a href="{{route('admin.customer_view_invoice',$row->id)}}" type="button" class="badge badge-xs badge-info fw-600 text-xs">
                                            {{ $lang->data['view_customer'] ?? 'View Customer' }}
                                        </a>
                                        <a href="{{route('admin.customer_ledger',$row->id)}}" type="button" class="badge badge-xs badge-primary fw-600 text-xs">
                                            {{ $lang->data['view_ledger'] ?? 'View Ledger' }}
                                        </a>
