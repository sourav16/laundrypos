                                    ...
                                    <div class="">
                                        <div class="row mb-50 align-items-center">
                                            ...
                                            <div class="col-auto text-sm">
                                                {{ getFormattedCurrency($order->sub_total) }}</div>
                                        </div>
                                        <div class="row mb-50 align-items-center">
                                            <div class="col text-sm">{{ $lang->data['addon'] ?? 'Addon' }}:</div>
                                            <div class="col-auto text-sm">
                                                {{ getFormattedCurrency($order->addon_total) }}</div>
                                        </div>
                                        <div class="row mb-50 align-items-center">
                                            <div class="col text-sm">{{ $lang->data['discount'] ?? 'Discount' }}:
                                            </div>
                                            <div class="col-auto text-sm">{{ getFormattedCurrency($order->discount) }}
                                            </div>
                                        </div>
                                        <div class="row mb-3 align-items-center">
                                            ...
                                            <div class="col-auto text-sm">
                                                {{ getFormattedCurrency($order->tax_amount) }}</div>
                                        </div>
                                        <div class="row align-items-center">
                                            <div class="col text-sm fw-600">
                                                {{ $lang->data['gross_total'] ?? 'Gross Total' }}:</div>
                                            <div class="col-auto text-sm text-dark fw-600">
                                                {{ getFormattedCurrency($order->total) }}</div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="invoice-footer mb-15">
                            <div class="row-data">
                                ...
                                <h5 class="my-5">
                                    ...
                                    {{$customer && $customer->phone ? getCountryCode() : ''}} {{ $customer->phone ?? '' }}<br />
                                    {{ $customer->email ?? '' }}<br />
                                    {{ $customer->address ?? '' }}<br />
                                    @if ($customer)
                            ...
                            <div class="row-data">
                                ...
                                <h5 class="my-5">{{ getFormattedCurrency($paidamount) }}
                                </h5>
                            </div>
                            <hr>
                        </div>
