            ...
            <div class="card mb-4">
                ...
                <div class="row align-items-center px-4 mb-3">
                    <div class="col">
                        ...
                        <p class="text-sm text-success fw-600 mb-0"> {{ getFormattedCurrency($sub_total) }}</p>
                    </div>
                    <div class="col-auto">
                        ...
                        <div class="row g-2 align-items-center">
                            ...
                            <div class=" col-12">
                                ...
                                <div class="row mb-50 align-items-center">
                                    ...
                                    <div class="col-auto  text-sm fw-500"> {{ getFormattedCurrency($sub_total) }}</div>
                                </div>
                                <div class="row mb-50 align-items-center">
                                    <div class="col text-sm fw-500">{{ $lang->data['addon'] ?? 'Addon' }}:</div>
                                    <div class="col-auto text-sm fw-500"> {{ getFormattedCurrency($addon_total) }}</div>
                                </div>
                                <div class="row mb-50 align-items-center">
                                    <div class="col text-sm fw-500">{{ $lang->data['discount'] ?? 'Discount' }}:</div>
                                    <div class="col-auto  text-sm fw-500"> {{ getFormattedCurrency($discount) }}</div>
                                </div>
                                <div class="row mb-50 align-items-center">
                                    <div class="col text-sm fw-500">{{ $lang->data['tax'] ?? 'Tax' }}
                                        ({{ getTaxPercentage() }}%):</div>
                                    <div class="col-auto text-sm fw-500"> {{ getFormattedCurrency($tax) }}</div>
                                </div>
                                <hr>
                                <div class="row align-items-center">
                                    <div class="col text-sm fw-600">{{ $lang->data['gross_total'] ?? 'Gross Total' }}:
                                    </div>
                                    <div class="col-auto text-sm fw-600"> {{ getFormattedCurrency($total) }}</div>
                                </div>
                                <hr>
                                <div class="row ">
