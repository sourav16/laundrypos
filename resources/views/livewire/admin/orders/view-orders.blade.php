                                ...
                                @foreach ($orders as $item)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <p class="text-sm px-3 mb-0">{{$item->phone_number ? getCountryCode() : ''}} {{ $item->phone_number ?? '-' }}</p>
                                        </td>
                                        <td>
                                            <p class="text-sm px-3 font-weight-bold mb-0"> {{ getFormattedCurrency($item->total) }}</p>
                                        </td>
                                        ...
                                        <td class="px-3">
                                            ...
                                            <p class="text-sm mb-1">
                                                ...
                                                <span class="font-weight-bold"> {{ getFormattedCurrency($paid_amount) }}</span>
                                            </p>
                                        ...
                                        <td>
                                            ...
                                            <a href="#" type="button" wire:click.prevent="deleteOrder({{$item->id}})"
                            ...
                            <div class="row g-2 align-items-center">
                                <div class=" col-12">
                                    ...
                                    <div class="row mb-50 align-items-center">
                                        ...
                                        <div class="col-auto text-sm fw-500">
                                            {{ getFormattedCurrency($paid_amount) }}</div>
                                    </div>
                                    <hr>
