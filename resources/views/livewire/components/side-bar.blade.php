    ...
    <aside class="@if(isRTL() == true) sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-end me-4 rotate-caret @else  sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 ps ps--active-y @endif" id="sidenav-main" data-color="primary">
        <div class="">
            ...
            <a class="navbar-brand m-0 d-flex align-items-center" href="{{route('admin.dashboard')}}">
                ...
                {{-- <div class="ms-2 mb-0 pb-0 h6 font-weight-bold text-uppercase text-break text-wrap h-100 unique-title-main">
                    {{Str::limit(getApplicationName(),12)}}
                </div> --}}
            </a>
        </div>
        <div class="collapse navbar-collapse  w-auto h-auto h-100" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link {{ Request::is('admin/receipt*') ? 'active' : '' }}" href="{{route('admin.receipt')}}">
                        <div class="icon icon-shape icon-sm text-center d-flex align-items-center justify-content-center">
                            <i class="fa fa-file-text-o  text-pink text-sm opacity-10"></i>
                        </div>
                        <span class="nav-link-text ms-1">{{$lang->data['payment_receipt'] ?? 'Payment Receipt'}}</span>
                    </a>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div class="collapse {{ Request::is('admin/reports*') ? 'show' : '' }}" id="tasks">
                        <ul class="nav ms-4">
                            ...
                            <li class="nav-item ">
                                <a class="nav-link {{ Request::is('admin/reports/ledger') ? 'active' : '' }}" href="{{route('admin.ledger_report')}}">
                                    <span class="sidenav-mini-icon side-bar-inner"> S </span>
                                    <span class="sidenav-normal side-bar-inner"> {{$lang->data['ledger_report'] ?? 'Ledger Report'}}</span>
                                </a>
                            </li>
                            <li class="nav-item ">
