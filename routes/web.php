...
Route::group(['prefix' => 'admin','middleware' => ['store','installed']], function () {
    ...
    Route::get('receipt', \App\Http\Livewire\Admin\Payments\PaymentReceipt::class)->name('admin.receipt');
    Route::get('customers/ledger/{id}', \App\Http\Livewire\Admin\Customers\CustomerLedger::class)->name('admin.customer_ledger');
    Route::get('customers/view/{id}', \App\Http\Livewire\Admin\Customers\ViewCustomerInvoice::class)->name('admin.customer_view_invoice');
    Route::get('customers/view/payments/{id}', \App\Http\Livewire\Admin\Customers\ViewCustomerPayments::class)->name('admin.customer_view_payments');
    /* orders */
    ...
    Route::get('ledger', \App\Http\Livewire\Admin\Reports\CustomerLedger::class)->name('admin.ledger_report');
    /* print reports */
