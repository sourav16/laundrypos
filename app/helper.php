...
function getSiteLogo() {
    ...
    {
        $favicon = (($site['default_logo']) && ($site['default_logo'] !=""))? $site['default_logo'] : 'assets/img/logoc.webp';
        return $favicon;
    }
    return 'assets/img/logoc.webp';
}
    ...
    if(isSMSEnabled() == true)
    {
        ...
        try{
            ...
            if($customer)
            {
                ...
                $client->messages->create(getCountryCode().$customer->phone, 
                    ['from' => $twilio_number, 'body' => $message]);
            }
        }
        catch(\Exception $e)
