...
class MasterSetting extends Component
{
    ...
    public $default_state,$default_city,$default_district,$default_zip_code,$default_address,$user,$email,$password,$default_logo,$default_favicon,$currency_alignment=1;
    public $old_favicon,$old_logo,$default_printer=1,$lang,$country_code;
    use WithFileUploads;
    /* render the page */
    ...
    public function mount()
    {
        ...
        $this->currency_alignment = (isset($site['default_currency_alignment']) && !empty($site['default_currency_alignment'])) ? $site['default_currency_alignment'] : 1;
    ...
    public function save() {
        ...
        $site['default_currency_alignment'] = $this->currency_alignment;
